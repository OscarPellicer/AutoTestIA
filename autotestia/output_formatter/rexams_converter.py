...
def prepare_for_rexams(records: List[QuestionRecord], output_dir: str, max_image_width: Optional[int] = None, max_image_height: Optional[int] = None):
    ...
    for i, record in enumerate(records):
        ...
        try:
            ...
            if record.image_reference:
                ...
                rmd_content.append(f"```{'{r}'}{r_opts} include_graphics('{image_filename}')\n```\n")
