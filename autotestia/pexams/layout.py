...
class AnswerSheetLayout(NamedTuple):
    ...
    exam_subtitle: Tuple[float, float]
...
GROUP_CONTENT_WIDTH = (QUESTION_NUMBER_WIDTH + (5 * OPTION_BOX_WIDTH) + (4 * OPTION_BOX_HORIZONTAL_SPACING))
...
def get_answer_sheet_layout(num_questions: int, id_length: int = 10) -> AnswerSheetLayout:
    ...
    return AnswerSheetLayout(
        ...
        exam_subtitle=EXAM_SUBTITLE_POS,
